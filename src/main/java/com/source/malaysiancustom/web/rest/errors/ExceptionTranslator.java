package com.source.malaysiancustom.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
            ...
            .map(
                f ->
                    new FieldErrorVM(
                        ...
                        f.getField(),
                        messageSource.getMessage(f.getDefaultMessage(), new Object[0], LocaleContextHolder.getLocale())
                    )
            )
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.source.malaysiancustom.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        com.source.malaysiancustom.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.source.malaysiancustom.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.source.malaysiancustom");
    }
}
