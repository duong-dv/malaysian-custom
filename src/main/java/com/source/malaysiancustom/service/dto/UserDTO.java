...
public class UserDTO {
    ...
    public UserDTO(User user) {
        ...
        this.loginFalse = user.getLoginFalse();
        this.loginFirst = user.isLoginFirst();
        this.questionOne = user.getQuestionOne();
        this.questionTwo = user.getQuestionTwo();
        this.questionThree = user.getQuestionThree();
        this.questionOneAnswer = user.getQuestionOneAnswer();
        this.questionTwoAnswer = user.getQuestionTwoAnswer();
        this.questionThreeAnswer = user.getQuestionThreeAnswer();
    }
    ...
    public Long getLoginFalse() {
        return loginFalse;
    }

    public void setLoginFalse(Long loginFalse) {
