package com.source.malaysiancustom.domain;
...
public class User extends AbstractAuditingEntity implements Serializable {
    ...
    @Column(name = "login_first", length = 5)
    ...
    @Column(name = "question_one_answer")
    private String questionOneAnswer;

    @Column(name = "question_two_answer")
    private String questionTwoAnswer;

    @Column(name = "question_three_answer")
